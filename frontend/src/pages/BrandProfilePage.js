...
import { Bot, Save, Globe, Loader2, AlertCircle } from "lucide-react";
...
export default function BrandProfilePage() {
  ...
  const handleSave = async () => {
    ...
    setSaving(true);
    try {
      await brandAPI.update(selectedBrand.id, { name, tone, industry });
  ...
  const handleAnalyzeWebsite = async () => {
    ...
    setAnalyzing(true);
    try {
      const response = await brandAPI.analyze(selectedBrand.id, websiteUrl);
  ...
  return (
    <Layout>
      <div className="p-8">
        <div className="mb-8">
          <h1 className="text-4xl font-bold font-outfit text-slate-900 mb-2">Café Settings</h1>
          <p className="text-lg text-slate-600">Manage your café brand information and AI insights</p>
        </div>
        ...
        {selectedBrand ? (
          <div className="max-w-4xl space-y-6">
            ...
            <div className="bg-white rounded-2xl border border-slate-100 shadow-sm p-8">
              <h3 className="text-xl font-semibold font-outfit text-slate-900 mb-6">Café Profile</h3>
              <div className="space-y-6">
                ...
                <div>
                  ...
                  <Input
                    ...
                    className="rounded-xl border-slate-200 bg-slate-50/50 px-4 py-3 text-base"
                    placeholder="Warm, Cozy, Inviting..."
                  />
                </div>
                ...
                <div>
                  ...
                  <Input
                    ...
                    className="rounded-xl border-slate-200 bg-slate-50/50 px-4 py-3 text-base"
                    placeholder="Café, Coffee Shop, Bakery..."
                  />
                </div>
          ...
          <div className="bg-white rounded-2xl border border-slate-100 shadow-sm p-12 text-center">
            ...
            <h2 className="text-2xl font-semibold font-outfit text-slate-900 mb-2">No café yet</h2>
            <p className="text-slate-600 mb-6">Create your café profile to get started</p>
            <Button
